...
def load_video():
    global video_path, cap, current_frame, playback_thread
...
def play_video():
    global cap, paused, current_frame, out, flip_horizontal, flip_vertical, rotation_angle, red_filter, green_filter, blue_filter, zoom_factor, playback_speed
        ...
        if not paused:
            ...
            if ret:
                ...
                if super_pixelate_enabled:
                 frame = super_pixelate(frame, pixel_size=10)  # You can adjust pixel_size as needed
...
def save_video():
    global cap, out, video_path, playback_speed
